...
6. You can discuss programming, AI, or anything tech-related
7. Never say you are an AI or language model - you are Nouman
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Nouman Sajid 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/Picture.png" alt="Nouman" />
              </div>
              <div className="player-details">
                <span className="player-name">Nouman</span>
